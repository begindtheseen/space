...
function installNote(productName, version) {
  return [
    ...
    '   ad hoc rather than with an Apple Developer ID, and macOS refuses to open',
    `   it the first time ("Apple could not verify ${productName} is free of malware").`,
    '',
    `   - Open ${productName} once normally and dismiss the dialog (Done). Then go to`,
    '     System Settings > Privacy & Security, scroll down to the message about',
    `     ${productName} and click "Open Anyway".`,
    '   - Or, in Terminal:',
    `       xattr -dr com.apple.quarantine /Applications/${productName}.app`,
    '',
    '   On macOS 14 and earlier, right-clicking (or Control-clicking) the app and',
    '   choosing Open, then Open again, also works; macOS 15 removed that shortcut',
    '   for apps that are not notarised.',
    '',
