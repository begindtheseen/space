...
The five-step coast and the four-step Riccati run above both trend the same way: the predicted position variance climbed early, then began flattening out. Before asking whether it keeps flattening forever, the next lesson takes a detour through the one quantity this lesson has treated as fixed scenery — $\mathbf{Q}$ itself — and what happens when it is wrong.
