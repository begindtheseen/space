...
| Choosing $\Delta t_{\text{plant}}$ | From the physics (structural and slosh modes, coupling periods), confirmed by a refinement study — never inherited from the control rate without checking |
