...
::: check
The value-gradient check found $V_x(0)$ and the finite-difference $\Delta J^\star/\Delta h_0$ agreeing to four significant figures using two full $115$-iteration re-optimisations. Why is this check more convincing than simply trusting the theoretical claim that $V_x$ is the costate?
:::
