...
::: check
A powered-descent project's write-up states the cost, the dynamics, and the thrust bounds, but does not say whether the thrust lower bound was convexified or dropped from the formulation entirely. Why does this omission matter more than it might first appear to?
:::
